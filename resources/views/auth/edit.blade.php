        ...
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Mengedit Login</span>
                </h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-lx-4 col-lxx-3">
                                        <div class="form-check form-check-custom form-check-solid">
                                            ...
                                            <input class="form-check-input me-3" name="status" type="radio"
                                                value="editor" id="kt_modal_update_role_option_1"
                                                {{ $one->status == 'editor' ? 'checked' : '' }} required>
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-lx-4 col-lxx-3">
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="status" type="radio"
                                                value="viewer" id="kt_modal_update_role_option_2"
                                                {{ $one->status == 'viewer' ? 'checked' : '' }} required>
                                            <!--end::Input-->
                                            <!--begin::Label-->
