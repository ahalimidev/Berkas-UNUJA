...
<h3>Mengedit Kategori Berkas</h3>
@endsection
        ...
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Mengedit Kategori Berkas</span>
                </h3>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-sm-6 align-content-center">
                            ...
                            <div class="d-flex flex-column mb-8 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" name="nama_kategori_berkas" class="form-control form-control-sm " value="{{$one->nama_kategori_berkas}}"   required />
                            </div>
