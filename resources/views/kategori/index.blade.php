        ...
        <div class="card mb-5 mb-xl-8 border-2 shadow p-3 mb-5 bg-white rounded">
            <div class="card-header">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">List Kategori Berkas</span>
                </h3>
                <div class="card-toolbar">

                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <a type="button" class="btn btn-sm btn-primary" href="{{ route('kategori.create') }}">Add
                            Kategori Berkas</a>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="text-muted mb-3">
                    Pada halaman ini digunakan untuk menambah, mengedit, dan detail Kategori Berkas
                </div>
            ...
            var table = $('#example').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: "action",
                        render: function(data) {
                            var detail = '{{ route('kategori.show', [':kategori']) }}';
                            var edit = '{{ route('kategori.edit', [':kategori']) }}';
                            var x_edit = "";
                            var x_detail = "";
                            x_detail =
