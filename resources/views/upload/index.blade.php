            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <a type="button" class="btn btn-sm btn-primary" href="{{ route('upload.create') }}">Add Upload Berkas</a>
                    </div>
                </div>
    ...
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            var detail = '{{ route('upload.show', [':upload']) }}';
                            var edit = '{{ route('upload.edit', [':upload']) }}';
                            var x_edit = "";
                            var x_download = "";
                            var x_detail = "";
                            var x_delete = "";
        ...
        function deleteConfirmation(upload) {
            Swal.fire({
                ...
                if (result.value) {
                    var destroy = '{{ route('upload.destroy', [':upload']) }}';
                    $.ajax({
