            ...
            var table = $('#example').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: "action",
                        render: function(data) {
                            var detail = '{{ route('user.show', [':user']) }}';
                            var edit = '{{ route('user.edit', [':user']) }}';
                            var x_edit = "";
                            var x_detail = "";
                            var x_delete = "";
                                x_detail =
                                    `<a data-toggle='tooltip' data-placement='top' title='Detail' href='${detail.replace(':user', data)}' class='btn btn-icon btn-bg-light btn-active-text-primary btn-sm me-1'><span class='bi bi-file-text ' aria-hidden='true'></span></a>`;
                                x_edit =
                                    `<a data-toggle='tooltip' data-placement='top' title='activate/deactivate' href='${edit.replace(':user', data)}' class='btn btn-icon btn-bg-light btn-active-text-primary btn-sm me-1'><span class='bi bi-pencil ' aria-hidden='true'></span> </a>`;
                                x_delete =
